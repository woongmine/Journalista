...
<header id="header">
    ...
    <div class="nav-link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img width="45px" height="55px" class="img-fluid rounded-circle" src="/resources/images/profile/${member.m_no}.jpg" onError="this.src='/resources/images/profile/default.jpg';" alt="${member.name}"></div>
