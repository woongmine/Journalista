			...
			if(totemail.equals(vo.getEmail())) {
				...
				if(cnt == 1) {
					...
					sendMail.setText(
							...
							.append("<p style=\"box-sizing: inherit; margin-top: 2em; margin-bottom: 2em; border: 0px; font: inherit; vertical-align: baseline; color: rgb(187, 187, 187);\"><a href='http://journalista.co.kr/member/emailConfirm?email=")
